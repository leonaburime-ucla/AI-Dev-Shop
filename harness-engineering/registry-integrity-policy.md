...
Every canonical shared skill at `skills/*/SKILL.md` must be represented in `project-knowledge/routing/skills-registry.md`.
...
Intentional exclusions belong in `project-knowledge/routing/skills-registry-exceptions.md`.
