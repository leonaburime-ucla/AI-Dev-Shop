...
| spec_root | harness-engineering/agent-evals/architect-evals/scorecard-suite/eval-2-analytics-export-platform/seed-state/project/reports/pipeline/202-analytics-export-platform |
