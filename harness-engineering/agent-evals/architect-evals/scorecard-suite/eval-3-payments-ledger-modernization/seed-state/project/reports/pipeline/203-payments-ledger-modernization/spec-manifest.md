...
| spec_root | harness-engineering/agent-evals/architect-evals/scorecard-suite/eval-3-payments-ledger-modernization/seed-state/project/reports/pipeline/203-payments-ledger-modernization |
