...
| spec_root | harness-engineering/agent-evals/architect-evals/benchmark-suite/eval-4-thin-evidence-concept/seed-state/project/reports/pipeline/204-thin-evidence-concept |
