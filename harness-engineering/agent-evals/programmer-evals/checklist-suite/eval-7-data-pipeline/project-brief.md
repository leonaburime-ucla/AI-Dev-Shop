...
Build a data pipeline that transforms, validates, and enriches customer records for a CRM sync in TypeScript.
...
- Pure TypeScript, no external dependencies except injected plan service
- Must include tests
