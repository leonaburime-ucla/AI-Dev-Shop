...
- **Evidence path:** `project/src/evaluator.ts` — canAccess loop
...
- **Evidence path:** `project/src/evaluator.ts` — no limits
...
- **Evidence path:** `project/src/evaluator.ts` — grantRole function
...
- **Evidence path:** `project/src/evaluator.ts` — permissionCache Map
...
- **Evidence path:** `project/src/evaluator.ts` — `new Date()` in grantRole/revokeRole
...
- **Evidence path:** `project/src/evaluator.ts` — logging pattern
...
- **Evidence path:** `project/src/evaluator.ts` — wildcard permission check
...
- **Evidence path:** `project/src/evaluator.ts` — revokeRole splice
