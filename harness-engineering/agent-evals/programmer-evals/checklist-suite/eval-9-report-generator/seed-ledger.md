...
Evidence path: project/src/reporter.ts — detailed format output
...
Evidence path: project/src/reporter.ts — switch in 3 functions
...
Evidence path: project/src/reporter.ts — generateReport JSDoc
...
Evidence path: project/src/reporter.ts — aggregate calculations
...
Evidence path: project/src/__tests__/reporter.test.ts — only 4 tests
...
Evidence path: project/src/reporter.ts — AbstractReportFormatter, FormatterFactory
...
Evidence path: project/src/reporter.ts — reduce accumulation
