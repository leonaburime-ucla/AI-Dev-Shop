...
Evidence path: project/src/scheduler.ts — handleTask function
...
Evidence path: project/src/scheduler.ts — CONFIG object and scorePriority function
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/scheduler.ts — handleTask signature
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/scheduler.ts — multiple return statements
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/scheduler.ts — scorePriority function
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/scheduler.ts — notifyWebhook call inside scorePriority
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/scheduler.ts — assignTask function
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/scheduler.ts — remainingCapacity variable
Caught by Programmer:
Caught by Code Review:
