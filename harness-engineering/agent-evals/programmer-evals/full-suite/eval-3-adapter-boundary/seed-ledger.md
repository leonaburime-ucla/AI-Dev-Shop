...
Evidence path: project/src/adapter.ts — charge method log line
...
Evidence path: project/src/adapter.ts — catch blocks
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/adapter.ts — no timeout logic
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/adapter.ts — console.log and new Date()
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: All source files — no handoff documentation
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/__tests__/adapter.test.ts
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/adapter.ts — refund and getTransaction methods
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
