...
Evidence path: project/src/query-builder.ts — ORDER BY clause
...
Evidence path: project/src/query-builder.ts — console.log line
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/query-builder.ts — no pageSize check
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/query-builder.ts — default fallbacks
Caught by Programmer:
Caught by Code Review:
...
Evidence path: project/src/query-builder.ts — return type
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/query-builder.ts — function signature
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/query-builder.ts — monolithic function
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/__tests__/query-builder.test.ts
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
...
Evidence path: project/src/query-builder.ts — JSDoc
Caught by Programmer:
Caught by Code Review:
False positive risk: Low
Framework change needed: No
