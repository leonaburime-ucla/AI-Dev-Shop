...
Build a permission evaluator for a document management system in TypeScript.
...
- Pure TypeScript, no external dependencies except injected role service and audit logger
- Must include tests
