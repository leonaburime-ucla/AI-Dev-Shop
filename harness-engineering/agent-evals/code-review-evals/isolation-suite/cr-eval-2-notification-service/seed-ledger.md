...
**Eval ID**: isolation-suite / cr-eval-2-notification-service
...
Evidence path:       project/src/notification-service.ts — NotificationPriority type definition
...
Evidence path:       project/src/notification-service.ts — sendNotification() retry loop
...
Evidence path:       project/src/__tests__/notification-service.test.ts — sendNotification tests
...
Evidence path:       project/src/notification-service.ts — generateNotificationId()
...
Evidence path:       project/src/notification-service.ts — legacyNotify()
...
Evidence path:       project/src/notification-service.ts — comment near rate limiting section
