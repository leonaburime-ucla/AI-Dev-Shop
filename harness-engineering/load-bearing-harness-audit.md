...
`<AI_DEV_SHOP_ROOT>/framework/reports/maintenance/harness-load-bearing-<YYYY-MM-DD>.md`
...
It should fail when a retained `framework/reports/maintenance/harness-load-bearing-*.md` report is missing the required sections, benchmark inventory, or component decisions.
