...
| Mechanical Enforcement | B | `harness-engineering/validators/`, `.github/workflows/harness-validators.yml`, `harness-engineering/ci-enforcement.md`, `harness-engineering/registry-integrity-policy.md` | More rules are enforced mechanically now, but most behavioral quality rules still depend on markdown gates rather than executable checks. |
| Evaluation And Benchmarking | B- | `reports/benchmarks/README.md`, `reports/benchmarks/spec-agent/`, `reports/benchmarks/architect-agent/`, `reports/benchmarks/tdd-agent/`, `reports/benchmarks/programmer-agent/`, `reports/benchmarks/testrunner-agent/`, `reports/benchmarks/code-review-agent/`, `reports/benchmarks/security-agent/`, `skills/evaluation/eval-rubrics.md` | Benchmarks now span implementation and verification roles, but they are still scenario-based seed fixtures rather than executable eval harnesses. |
...
| Entropy Management | B | `agents/observer/skills.md`, `harness-engineering/observer-cadence.md`, `harness-engineering/validators/doc_garden_audit.py`, `.github/workflows/harness-maintenance.yml`, `reports/maintenance/harness-maintenance.md` | Cleanup is now scheduled and report-driven, but repair automation still opens reviewable PRs instead of silently fixing drift. |
| Self-Validation Loops | C+ | `harness-engineering/self-validation.md`, `templates/self-validation/`, `reports/self-validation/README.md`, `agents/programmer/skills.md`, `workflows/job-lifecycle.md` | The templates and gates now exist, but real downstream repos still need project-specific commands and environment wiring. |
| Run-Level Observability | B- | `.pipeline-state.md`, `templates/progress-ledger-template.md`, `harness-engineering/session-continuity.md`, `harness-engineering/context-offloading.md`, `reports/offloads/README.md`, `workflows/trace-schema.md`, Observer outputs | Resume quality and evidence hygiene are better, but there is still no consolidated dashboard or automatic artifact summarization layer. |
