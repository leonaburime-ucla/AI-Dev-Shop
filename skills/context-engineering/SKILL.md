...
**`AI-Dev-Shop/project-knowledge/project_memory.md`**
...
**`AI-Dev-Shop/project-knowledge/learnings.md`**
...
**`AI-Dev-Shop/project-knowledge/project_notes.md`**
...
When making any context engineering decision about where to write a memory entry, `AI-Dev-Shop/project-knowledge/knowledge-routing.md` is the authoritative source. It defines which file each category of memory belongs in and supersedes any informal judgment call.
...
| Architecture pattern choices | ADRs in `AI-Dev-Shop/specs/` |
| Reusable domain knowledge | `AI-Dev-Shop/skills/` files |
...
| Agent operating procedures | `AI-Dev-Shop/agents/*/skills.md` |
