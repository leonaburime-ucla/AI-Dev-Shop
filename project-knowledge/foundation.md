...
Why it matters: the Architect Agent's pattern library (`AI-Dev-Shop/skills/design-patterns/references/`) is built from these patterns. The TypeScript examples throughout the pattern files follow the two-object function paradigm documented in `AI-Dev-Shop/project-knowledge/project_notes.md`.
