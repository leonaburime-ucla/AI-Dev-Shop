...
Supplements `<AI_DEV_SHOP_ROOT>/project-knowledge/governance/tool-permission-policy.md`, which governs tool scope. This document governs data handling within those scopes.
