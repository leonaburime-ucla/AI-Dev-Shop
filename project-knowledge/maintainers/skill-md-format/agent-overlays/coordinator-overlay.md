...
- Run pre-dispatch gate using `project-knowledge/maintainers/skill-md-format/gates-and-handoffs.md`.
...
- Emit compact payload matching `project-knowledge/maintainers/skill-md-format/gates-and-handoffs.md`.
