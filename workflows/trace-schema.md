...
Add `[TRACE]` entries to `project-knowledge/memory-store.md`. Use for small features or when simplicity is preferred. Downside: mixes traces with DECISION/FAILURE/FACT entries.
...
- Weekly: aggregate signals from all feature traces to identify recurring patterns
