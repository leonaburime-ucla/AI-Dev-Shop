...
Available commands: `/spec` `/plan` `/tasks` `/implement` `/code-review` `/clarify` `/agent` `/consensus` `/debate` `/audit-work` `/cowork`
...
After setup, `/spec`, `/plan`, `/code-review`, `/consensus`, `/debate`, `/audit-work`, `/cowork`, etc. work directly in chat.
