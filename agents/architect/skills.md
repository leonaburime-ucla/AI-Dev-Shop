...
7. Write ADR to `AI-Dev-Shop/specs/<NNN>-<feature-name>/adr.md` using `AI-Dev-Shop/templates/adr-template.md`. Complete the Constitution Check table, Research Summary field, and Complexity Justification table.
